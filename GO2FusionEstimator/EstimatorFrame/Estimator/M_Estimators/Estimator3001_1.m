function StateSpaceModelN = Estimator3001_1(StateSpaceModelN)
% Linear Kalman with Joseph Update
% 作者：光电所一室2020级  孙敏行   联系方式：401435318@qq.com
    ...
    % 协方差更新 E3001_1_P
    StateSpaceModelN.Matrix_P = (eye(StateSpaceModelN.Nx) - K * StateSpaceModelN.Matrix_H) * P_pre * (eye(StateSpaceModelN.Nx) - K * StateSpaceModelN.Matrix_H)' + K * StateSpaceModelN.Matrix_R * K';
