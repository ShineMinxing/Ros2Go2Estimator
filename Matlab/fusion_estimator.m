...
hold on; grid on;
plot(t_plot, odom_log(range,2),"ro");
plot(t_plot, odom_log(range,3),"go");
plot(t_plot, odom_log(range,4),"bo");
xlim(ZoomTime);
legend('CAPO-X', 'CAPO-Y', 'CAPO-Z', 'Location','best','FontSize', WordSize);
