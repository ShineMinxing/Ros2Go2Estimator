...
#include "fusion_estimator/src/FusionEstimator/fusion_estimator.h"
...
void mexFunction(int nlhs, mxArray* plhs[], int nrhs, const mxArray* prhs[])
{
    ...
    if (std::strcmp(cmd, "step") == 0) {
        ...
        const char* fn[] = {"XPos","YPos","ZPos","XVel","YVel","ZVel","XAcc","YAcc","ZAcc","RollRad","PitchRad","YawRad","RollVel","PitchVel","YawVel","RollAcc","PitchAcc","YawAcc","FootfallAverageX","FootfallAverageY","FootfallAverageYaw","FLFootLanded","FRFootLanded","RLFootLanded","RRFootLanded","LoadedWeight"};
        ...
        mxSetField(plhs[0], 0, "FootfallAverageYaw",mxCreateDoubleScalar((double)odom.FootfallAverageYaw));
